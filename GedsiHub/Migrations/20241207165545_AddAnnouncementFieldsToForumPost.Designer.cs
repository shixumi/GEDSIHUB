...
namespace GedsiHub.Migrations
{
    ...
    [Migration("20241207165545_AddAnnouncementFieldsToForumPost")]
    partial class AddAnnouncementFieldsToForumPost
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GedsiHub.Models.Module", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ModuleId = 1,
                            Color = "#000000",
                            CreatedDate = new DateTime(2024, 12, 7, 16, 55, 44, 829, DateTimeKind.Utc).AddTicks(5756),
                        ...
                        new
                        {
                            ModuleId = 2,
                            Color = "#000000",
                            CreatedDate = new DateTime(2024, 12, 7, 16, 55, 44, 829, DateTimeKind.Utc).AddTicks(5758),
                        ...
                        new
                        {
                            ModuleId = 3,
                            Color = "#000000",
                            CreatedDate = new DateTime(2024, 12, 7, 16, 55, 44, 829, DateTimeKind.Utc).AddTicks(5760),
                        ...
                        new
                        {
                            ModuleId = 4,
                            Color = "#000000",
                            CreatedDate = new DateTime(2024, 12, 7, 16, 55, 44, 829, DateTimeKind.Utc).AddTicks(5762),
                        ...
                        new
                        {
                            ModuleId = 5,
                            Color = "#000000",
                            CreatedDate = new DateTime(2024, 12, 7, 16, 55, 44, 829, DateTimeKind.Utc).AddTicks(5763),
                        ...
                        new
                        {
                            ModuleId = 6,
                            Color = "#000000",
                            CreatedDate = new DateTime(2024, 12, 7, 16, 55, 44, 829, DateTimeKind.Utc).AddTicks(5765),
                        ...
                        new
                        {
                            ModuleId = 7,
                            Color = "#000000",
                            CreatedDate = new DateTime(2024, 12, 7, 16, 55, 44, 829, DateTimeKind.Utc).AddTicks(5767),
            ...
            modelBuilder.Entity("XApiStatement", b =>
                {
                    ...
                    b.Property<string>("ActorAccountHomePage")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("ContextRegistration")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("ObjectDefinitionDescription")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("ObjectDefinitionName")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("GedsiHub.Models.Quiz.Answer", b =>
                {
                    b.HasOne("GedsiHub.Models.Quiz.Choice", "Choice")
                        .WithMany()
                        .HasForeignKey("ChoiceID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("GedsiHub.Models.Quiz.Question", "Question")
                        .WithMany()
            ...
            modelBuilder.Entity("GedsiHub.Models.Quiz.Exam", b =>
                {
                    b.HasOne("GedsiHub.Models.Module", "Module")
                        .WithOne("Exam")
                        .HasForeignKey("GedsiHub.Models.Quiz.Exam", "ModuleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("GedsiHub.Models.Quiz.Question", b =>
                {
                    b.HasOne("GedsiHub.Models.Quiz.Exam", "Exam")
                        .WithMany()
