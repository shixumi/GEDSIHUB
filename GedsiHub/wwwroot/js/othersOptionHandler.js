document.addEventListener("DOMContentLoaded", function () {
    // Function to handle dropdown and input behavior
        ...
        // Apply the function for both suggestion and issue select elements
        ...
        handleSelectChange(suggestionSelectElement, suggestionInputElement); // For suggestions
        handleSelectChange(issueSelectElement, issueInputElement); // For issues (complaints
